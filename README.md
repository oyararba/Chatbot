...
- FINAL NOTE: Assignment was said to be simple but if i was extending this further I'd make this both a) on SQL with a proper database instead of object dictionaries but also b) more fault tolerant with on-site data sharding and replication but since i want it more easily reproducible/scale is small for this assn, we can just have it as object lookup tables for a quick example. 
